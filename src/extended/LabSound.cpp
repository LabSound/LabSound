...
namespace lab
{
    ...
    std::unique_ptr<lab::AudioContext> MakeRealtimeAudioContext(int numChannels, float sample_rate)
    {
    ...
    std::unique_ptr<lab::AudioContext> MakeOfflineAudioContext(int numChannels, float recordTimeMilliseconds)
    {
