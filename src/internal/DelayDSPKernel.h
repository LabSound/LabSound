...
public:  
    ...
    void process(ContextRenderLock&, const float* source, float* destination, uint32_t frames);
    
    virtual void process(ContextRenderLock&, const float* source, float* destination) override;
