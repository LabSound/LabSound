...
void PannerNode::pullInputs(ContextRenderLock& r)
{
    ...
    AudioNode::pullInputs(r);
}

void PannerNode::process(ContextRenderLock & r)
{
    ...
    m_panner-> pan(r, azimuth, elevation, source, destination);
